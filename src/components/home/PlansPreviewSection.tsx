      ...
      <div className="container-width">
        ...
        >
          <p className="text-xs sm:text-sm text-foreground text-center leading-relaxed">
            ...
            Talk Point Communication does NOT sell these plans. We charge separate fees for our assistance services to help you understand and navigate these options.
          </p>
        </motion.div>
