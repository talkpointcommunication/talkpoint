...
const testimonials = [
  {
    name: 'Sarah Johnson',
    role: 'Remote Worker',
    content: 'The independent advisors at Talk Point Communication helped me understand which streaming and entertainment options would work best for my family. Their unbiased guidance was invaluable!',
    rating: 5,
    avatar: 'SJ',
  },
  {
