...
const steps = [
  {
    ...
    description: 'Share your entertainment interests and device types with our independent advisors.',
  },
  {
    icon: Calendar,
    title: 'Explore Streaming Options',
    description: 'We help you understand the available streaming services and content platforms.',
  },
  {
    icon: Wrench,
    title: 'Get Independent Guidance',
    description: 'Receive unbiased advice to help you understand subscription features and pricing.',
  },
  {
    icon: Wifi,
    title: 'Make Informed Decisions',
    description: 'Use our expert guidance to choose streaming services that fit your entertainment needs.',
  },
];
      ...
      <div className="container-width relative">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
            Finding Your Perfect Streaming Match is <span className="gradient-text">Easy</span>
          </h2>
