  ...
  return (
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0">
        ...
        <motion.img
          src={heroImage}
          alt="Background image of people enjoying streaming entertainment services with diverse content options"
      ...
      <div className="container-width relative z-20 min-h-screen flex items-center py-16 sm:py-20">
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            ...
            >
              <p className="text-[10px] xs:text-xs sm:text-sm text-foreground text-center leading-relaxed">
                <strong className="block sm:inline mb-1 sm:mb-0">Not a streaming provider. No brand affiliation.</strong> We are an independent third-party entertainment advisor providing guidance on streaming and on-demand options. We do NOT sell services or represent any streaming platform.
              </p>
            </motion.div>
            ...
            >
              <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-foreground mb-4 sm:mb-6 leading-[1.05] px-2">
                ...
                <span className="block mt-2 sm:mt-3">
                  <span className="gradient-text">Streaming & On-Demand</span>
                </span>
            ...
            >
              We are <span className="font-bold text-foreground">independent advisors</span> helping you understand streaming services, on-demand platforms, and entertainment subscriptions. Get <span className="font-bold text-foreground">unbiased guidance</span> to make informed decisionsâ€"no streaming provider affiliation.
            </motion.p>
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 md:gap-4 pt-4 sm:pt-6 px-4"
            >
