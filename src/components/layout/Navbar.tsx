      ...
      <div className="container-width !px-4 sm:!px-6 lg:!px-8 !py-3 sm:!py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3 xl:gap-4">
            <a href="tel:(888) 908-7317" className="hidden xl:flex items-center gap-2 text-xs lg:text-sm font-medium text-muted-foreground hover:text-primary transition-colors">
              <Phone className="w-3.5 h-3.5 lg:w-4 lg:h-4" />
              (888) 908-7317
            </a>
            <Button variant="cta" size="sm" asChild className="hidden xl:flex text-xs lg:text-sm">
              <a href="tel:(888) 908-7317">Get Independent Advice</a>
            </Button>
          </div>
          ...
          <div className="lg:hidden mt-4 pb-4 border-t border-border pt-4 animate-fade-up">
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              <div className="pt-3 sm:pt-4 border-t border-border mt-2">
                <a href="tel:(888) 908-7317" className="flex items-center gap-2 text-sm sm:text-base font-medium text-muted-foreground mb-3 sm:mb-4 touch-manipulation">
                  <Phone className="w-4 h-4" />
                  (888) 908-7317
                </a>
                <Button variant="cta" className="w-full touch-manipulation" asChild>
                  <a href="tel:(888) 908-7317">Get Guidance</a>
                </Button>
              </div>
            </div>
          </div>
