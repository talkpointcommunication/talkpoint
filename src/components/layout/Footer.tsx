        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm sm:text-base text-primary-foreground/70 mb-4 sm:mb-6 max-w-sm">
              An independent third-party advisory service helping you navigate streaming, music, and on-demand entertainment options. We are NOT a streaming provider or affiliated with any provider—we provide unbiased guidance only.
            </p>
            <div className="space-y-2 sm:space-y-3">
              ...
              <a href="mailto:support@talkpointcommunication.com" className="flex items-center gap-2 sm:gap-3 text-sm sm:text-base text-primary-foreground/70 hover:text-primary transition-colors">
                <Mail className="w-4 h-4" />
                support@talkpointcommunication.com
              </a>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10">
          <div className="bg-primary-foreground/10 rounded-xl p-6 mb-6 border-2 border-primary/20">
            <p className="text-sm text-primary-foreground font-medium text-center leading-relaxed">
              ...
              We are NOT an internet service provider (ISP). We are NOT affiliated, authorized, or endorsed by any telecom/cable company. We do NOT sell official ISP services. We do NOT provide guaranteed technical fixes. All mentions of providers are for informational purposes only. Talk Point Communication is an independent third-party advisory startup providing guidance services only.
            </p>
          </div>
          
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-primary-foreground/60">
              © {new Date().getFullYear()} Talk Point Communication. All rights reserved.
            </p>
