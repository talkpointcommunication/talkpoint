        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2 sm:space-y-3">
              <a href="tel:(888) 505-8837" className="flex items-center gap-2 sm:gap-3 text-sm sm:text-base text-primary-foreground/70 hover:text-primary transition-colors">
