              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Talk Point Communication is an independent third-party service assistance startup, launched in 2026, and is not affiliated with, endorsed by, or sponsored by any cable, internet, or streaming service provider. We provide guidance and assistance services only—we do not sell plans or services directly.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="prose prose-slate max-w-none space-y-8">
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Please note that Talk Point Communication charges separate service and assistance fees. These fees are distinct from any charges you may incur directly with internet, cable, or streaming service providers. Our refund policy applies only to the assistance fees charged by Talk Point Communication—not to provider charges.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="bg-accent/10 border-l-4 border-accent rounded-r-xl p-6">
                  <ul className="list-disc list-inside text-muted-foreground space-y-2">
                    <li>Talk Point Communication does not process refunds for service provider charges</li>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  If you have questions about our Refund Policy, please contact us at support@talkpointcommunication.com or call (888) 882-4649. Our support team is available 24/7 to assist you.
                </p>
              </section>
            </div>
          </motion.div>
