            ...
            <div className="prose prose-slate max-w-none space-y-8">
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Talk Point Communication provides guidance and assistance services only. We do not:
                </p>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  All trademarks, service marks, logos, and brand names mentioned on this website are the property of their respective owners. Their use on this website is purely for descriptive reference and educational purposes. Talk Point Communication claims no ownership or affiliation with these marks.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  While we strive to provide accurate and up-to-date information, Talk Point Communication makes no representations or warranties about:
                </p>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Talk Point Communication shall not be held liable for:
                </p>
                <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4 mt-4">
              ...
              <section>
                ...
                <div className="bg-secondary/50 rounded-xl p-6">
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4 mt-4">
                    ...
                    <li>Talk Point Communication cannot cancel, modify, or intervene in provider agreements on your behalf</li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-500 rounded-r-xl p-6">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-muted-foreground leading-relaxed">
                        Talk Point Communication makes no guarantees regarding service availability, pricing, installation timelines, or provider acceptance of your application. We provide assistance and guidance, but final decisions and service provisioning rest solely with the individual providers.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Talk Point Communication will never request your service provider account passwords, sensitive financial information, or Social Security numbers. We do not have access to provider billing systems or customer databases. For information on how we handle your data, please review our Privacy Policy.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="bg-secondary/50 rounded-xl p-6 space-y-3">
                  <p className="text-foreground font-medium">Talk Point Communication</p>
                  <p className="text-muted-foreground">
                    <strong>Phone:</strong> (888) 882-4649
                  </p>
                  <p className="text-muted-foreground">
                    <strong>Email:</strong> support@talkpointcommunication.com
                  </p>
