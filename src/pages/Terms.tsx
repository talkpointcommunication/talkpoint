        ...
        <div className="container-width max-w-4xl">
          ...
          <div className="bg-primary/10 border-2 border-primary/30 rounded-2xl p-6 mb-8">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Talk Point Communication is an <strong>independent third-party assistance service</strong>, launched in 2026. 
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-muted-foreground mb-4">
              Talk Point Communication is an independent third-party assistance platform that provides guidance 
            ...
            <p className="text-muted-foreground mb-4">
              Talk Point Communication shall not be liable for any indirect, incidental, special, consequential, 
            ...
            <p className="text-muted-foreground mb-4">
              ...
              <br />
              Email: legal@talkpointcommunication.com
              <br />
              Phone: (888) 882-4649
            </p>
          </div>
